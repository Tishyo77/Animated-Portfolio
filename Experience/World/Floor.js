...
export default class Floor
{
    ...
    setFloor()
    {
        ...
        this.geometry1 = new THREE.PlaneGeometry(100, 100);
    ...
    setCircles()
    {
        ...
        const material = new THREE.MeshStandardMaterial({ color: 0x9687c4 });
        const material2 = new THREE.MeshStandardMaterial({ color: 0x6584e6 });
        ...
        this.circleFirst.position.x = 0.25;
        this.circleSecond.position.y = -0.28;
        this.circleSecond.position.x = 2.25;
